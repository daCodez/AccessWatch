...
public sealed class NotificationAndViewModelTests
{
    ...
    public void DashboardShellXaml_BindsSidebarSelectionToSelectedPage()
    {
        ...
        Assert.Contains("Text=\"MAC \"", xaml);
        Assert.Contains("Text=\"Vendor \"", xaml);
        Assert.Contains("Text=\"Seen \"", xaml);
        ...
        Assert.Contains("Text=\"IP \"", xaml);
        Assert.Contains("Text=\"Process \"", xaml);
        Assert.Contains("Text=\"Reachability \"", xaml);
        Assert.Contains("Text=\"Target \"", xaml);
        Assert.Contains("Text=\"Scope \"", xaml);
        Assert.DoesNotContain("Text=\"{Binding SelectedPortDetail}\"", xaml);
        Assert.Contains("Text=\"{Binding SelectedPort.Endpoint}\"", xaml);
        Assert.Contains("Text=\"{Binding SelectedPort.SuggestedAction}\"", xaml);
        ...
        Assert.Contains("Text=\"Vendor \"", xaml);
        Assert.Contains("Text=\"Seen \"", xaml);
        Assert.DoesNotContain("Text=\"{Binding SelectedDeviceDetail}\"", xaml);
        Assert.Contains("Text=\"{Binding SelectedDevice.Name}\"", xaml);
        Assert.Contains("Text=\"{Binding SelectedDevice.RecommendedAction}\"", xaml);
        ...
        Assert.Contains("Text=\"{Binding SelectedApplication.Name}\"", xaml);
        Assert.Contains("Text=\"{Binding SelectedApplication.Detail}\"", xaml);
        ...
        Assert.Contains("Text=\"Events \"", xaml);
        Assert.Contains("Text=\"Updated \"", xaml);
